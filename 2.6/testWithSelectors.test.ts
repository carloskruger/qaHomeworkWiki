...
describe("Filling in the blanks", () => {
    ...
    test("filling in the blanks for real", async () => {
        await driver.findElement(hdrInput).sendKeys("One long sentence")
        await driver.findElement(mkeInput).sendKeys("four")
        await driver.findElement(oaiInput).sendKeys("four")
        await driver.findElement(nameInput).sendKeys("x")
        await driver.findElement(submitBtn).click()    
        await driver.findElement(errorMsg).click()
        await driver.findElement(clrBtn).click()
        expect(errorMsg.toString).toContain("Errors Received:")
    })
})